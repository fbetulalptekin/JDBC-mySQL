...
public class JDBC01_Query02 {
    ...
    public static void main(String[] args) throws ClassNotFoundException, SQLException {
        ...
        (1, 'ACB', 'Ali Can'),
        (2, 'RDB', 'Veli Gul'),
        (3, 'KMN', 'Ayse Gulmez');   --> (benim tablomun son hali bu değil, farklı veriler geliyor)
         */
        ...
        String selectQuery2 = "SELECT isim, iletisim_isim FROM firmalar WHERE id>1 ORDER BY isim DESC"; // bosluklara dikkat ederek yazmak bu formda daha kolay olabilir
        ...
        // NOT2 : Sorgumuzda SELECT'ten sonra sadece belli field'lari dondurmesini istiyorsak
